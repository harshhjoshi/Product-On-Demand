...
import {fontFamily, fontSize, responsiveWidth} from '../styles/variables';
  ...
  return (
    <View
      style={{
        ...
        width: responsiveWidth(100),backgroundColor:theme=='light'?colors.white:colors.black
      }}
    >
      <ScrollView showsVerticalScrollIndicator={false}> 
        ...
        >
          Welcome to Product On Demand! These terms and conditions outline the
          rules and regulations for the use of Reyna Solutions's Website,
          located at www.archesoftronix.com. By accessing this website we assume
          you accept these terms and conditions. Do not continue to use Product
          On Demand if you do not agree to take all of the terms and conditions
          ...
          interchangeable and therefore as referring to same. Cookies We employ
          the use of cookies. By accessing Product On Demand, you agreed to use
          cookies in agreement with the Reyna Solutions's Privacy Policy. Most
          ...
          cookies. License Unless otherwise stated, Reyna Solutions and/or its
          licensors own the intellectual property rights for all material on
          Product On Demand. All intellectual property rights are reserved. You
          may access this from Product On Demand for your own personal use
          subjected to restrictions set in these terms and conditions. You must
          not: Republish material from Product On Demand Sell, rent or
          sub-license material from Product On Demand Reproduce, duplicate or
          copy material from Product On Demand Redistribute content from Product
          On Demand This Agreement shall begin on the date hereof. Our Terms and
          ...
          website. Reyna Solutions does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Reyna Solutions,its agents and/or
          ...
          laws, Reyna Solutions shall not be liable for the Comments or for any
          ...
          website. Reyna Solutions reserves the right to monitor all Comments
          ...
          hereby grant Reyna Solutions a non-exclusive license to use,
          reproduce, edit and authorize others to use, reproduce and edit any of
          your Comments in any and all forms, formats or media. Hyperlinking to
          our Content The following organizations may link to our Website
          without prior written approval: Government agencies; Search engines;
          News organizations; Online directory distributors may link to our
          ...
          absence of Reyna Solutions; and (d) the link is in the context of
          general resource information. These organizations may link to our home
          page so long as the link: (a) is not in any way deceptive; (b) does
          ...
          must inform us by sending an e-mail to Reyna Solutions. Please include
          ...
          site. No use of Reyna Solutions's logo or other artwork will be
          allowed for linking absent a trademark license agreement. iFrames
          Without prior approval and written permission, you may not create
          frames around our Webpages that alter in any way the visual
          presentation or appearance of our Website. Content Liability We shall
          not be hold responsible for any content that appears on your Website.
          ...
          policy at any time. By continuously linking to our Website, you agree
          to be bound to and follow these linking terms and conditions. Removal
          of links from our website If you find any link on our Website that is
          ...
          date. Disclaimer To the maximum extent permitted by applicable law, we
